...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Presentation File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo913.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Presentation File Extention")
        ...
        def genrate():
            try:
                if path.get()!="":
                    ...
                    if filextention.get()!="Presentation File Extention":
                        if filename.get()!="":

                            if filextention.get()=="Keynote presentation" and filename.get()!="":
                                touch.touch(a+"/{}.key".format(filename.get()))
                            
                            if filextention.get()=="OpenOffice Impress presentation file" and filename.get()!="":
                                touch.touch(a+"/{}.odp".format(filename.get()))
                        

                            if filextention.get()=="PowerPoint slide show" and filename.get()!="":
                                touch.touch(a+"/{}.pps".format(filename.get()))
                            

                            if filextention.get()=="PowerPoint presentation" and filename.get()!="":
                                touch.touch(a+"/{}.ppt".format(filename.get()))
                        
                            if filextention.get()=="PowerPoint Open XML presentation" and filename.get()!="":
                                touch.touch(a+"/{}.pptx".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Keynote presentation","OpenOffice Impress presentation file","PowerPoint slide show","PowerPoint presentation"\
        ...
        fileselect_combo.set("Presentation File Extention")
